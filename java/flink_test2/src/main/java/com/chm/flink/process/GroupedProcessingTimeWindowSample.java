...
public class GroupedProcessingTimeWindowSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        keyedStream.sum(1).keyBy(new KeySelector<Tuple2<String, Integer>, Object>() {
            ...
            @Override
            public void invoke(HashMap<String, Integer> stringIntegerHashMap) throws Exception {
                // 每个类型的商品成交量
                System.out.println(stringIntegerHashMap);
                // 商品成交总量
                System.out.println(stringIntegerHashMap.values().stream().mapToInt(v -> v).sum());
            }
        });
